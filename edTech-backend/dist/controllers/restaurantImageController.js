...
const uploadImage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.file) {
        ...
        appwrite_1.storage
            .createFile(environment_1.RESTAURANT_BUCKET_ID, appwrite_1.ID.unique(), file)
            .then((imageResponse) => {
            const imageUrl = `https://cloud.appwrite.io/v1/storage/buckets/${environment_1.RESTAURANT_BUCKET_ID}/files/${imageResponse.$id}/view?project=${environment_1.APPWRITE_PROJECT_ID}`;
